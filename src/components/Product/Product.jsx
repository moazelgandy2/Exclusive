...
function Product() {
  ...
  return (
    <>
      <div className="flex w-3/4 mx-auto gap-2 px-8 my-12">
        <div className="w-[10%] flex flex-col gap-2 justify-center items-center">
          <img
            onClick={handleImgClick}
            className="border border-red-500 cursor-pointer w-full"
        ...
        <div className="w-[55%] flex justify-center items-center  rounded-md overflow-hidden">
